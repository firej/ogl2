...
// Билдеры — статические методы Mat4 (имена translate/rotate/... в gl:: заняты
// под операции матричного стека, см. glmat.h).
#include <cmath>
...
struct Mat4 {
    ...
    static Mat4 rotate(float angleRad, float x, float y, float z) {
