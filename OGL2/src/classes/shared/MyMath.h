...
public:
  ...
  // Методы
  // Модуль
  double abs() { return sqrt(d.c.x * d.c.x + d.c.y * d.c.y + d.c.z * d.c.z); }
  ...
  Vector3 operator+(Vector3 vVector) {
    return Vector3(vVector.d.c.x + d.c.x, vVector.d.c.y + d.c.y,
                   vVector.d.c.z + d.c.z);
  }
  // Вычитание
  Vector3 operator-(Vector3 vVector) {
    return Vector3(d.c.x - vVector.d.c.x, d.c.y - vVector.d.c.y,
                   d.c.z - vVector.d.c.z);
  }
  // Умножение
  ...
  Vector3 operator-(const Vector3 &other) const {
    return Vector3(d.c.x - other.d.c.x, d.c.y - other.d.c.y,
                   d.c.z - other.d.c.z);
  }
  Vector3 operator+(const Vector3 &other) const {
    return Vector3(d.c.x + other.d.c.x, d.c.y + other.d.c.y,
...
public:
  ...
  // Умножение
  Vector2 operator*(double num) { return Vector2(x * num, y * num); }
  Vector2 operator*(float num) { return Vector2(x * num, y * num); }
  Vector2 operator*(char num) { return Vector2(x * num, y * num); }
  Vector2 operator*(int num) { return Vector2(x * num, y * num); }
  Vector2 operator*(long int num) { return Vector2(x * num, y * num); }
  // Деление
  Vector2 operator/(double num) { return Vector2(x / num, y / num); }
  Vector2 operator/(float num) { return Vector2(x / num, y / num); }
  Vector2 operator/(char num) { return Vector2(x / num, y / num); }
...
public:
  ...
  // Конструктор с инициализацией
  Color4(ColorComponent R, ColorComponent G, ColorComponent B,
         ColorComponent A) {
    d.c.r = R;
    d.c.g = G;
    d.c.b = B;
  ...
  // Методы
  // Модуль
  double abs() { return sqrt(d.c.r * d.c.r + d.c.g * d.c.g + d.c.b * d.c.b); }
  // Нормализация вектора (приведение модуля к 1)
  void normalize() {
  ...
  Color4 operator+(Color4 vVector) {
    return Color4(vVector.d.c.r + d.c.r, vVector.d.c.g + d.c.g,
                  vVector.d.c.b + d.c.b);
  }
  // Вычитание
  Color4 operator-(Color4 vVector) {
    return Color4(d.c.r - vVector.d.c.r, d.c.g - vVector.d.c.g,
                  d.c.b - vVector.d.c.b);
  }
  // Умножение
  ...
  Color4 operator-(const Color4 &other) const {
    return Color4(d.c.r - other.d.c.r, d.c.g - other.d.c.g, d.c.b - other.d.c.b,
                  1);
  }
  Color4 operator+(const Color4 &other) const {
    return Color4(d.c.r + other.d.c.r, d.c.g + other.d.c.g, d.c.b + other.d.c.b,
