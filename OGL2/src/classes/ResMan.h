...
typedef hash_map<string, ResourceObject>
    ResMapL_t; // Словарь для сопоставления имён и функций
...
typedef hash_map<string, ResPointer>
    ResMapH_t; // Словарь для сопоставления имён и функций
...
protected:
  ...
  FindRes_ret_t
  FindRes(ResMapH_Iter_t mapHi); /*	Поиск элемента в mapL, соотв-го данному
                                    ресурсу	*/
public:
  ResMan();
  ~ResMan();
