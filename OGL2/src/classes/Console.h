...
namespace Console {
enum Status { ST_VISIBLE = 0, ST_INVISIBLE = 1, ST_FADEIN = 2, ST_FADEOUT = 3 };
...
class CConsole {
   ...
   public:
    ...
    void SetFont(PFont CFont) { ConsoleFont = CFont; }  // Выбор консольного шрифта
    void INIT();
    void DEINIT();
   ...
   public:
    ...
    void RegFunc(char* s, ConFunc cf) { RegFunc(string(s), cf); }
    ...
    ConFuncsMap* GetMap(void) { return &CFmap; }
